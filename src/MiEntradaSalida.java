...
public class MiEntradaSalida {
    ...
    /**
     *
     * Set: se divide en (SortedSet(TreeSet), HashSet y LinkedHashSet) No hay orden y no se admiten elementos repetidos
     * List: se divide en (ArrayList, LinkedList) Hay orden y se admiten repetidos
     * Queue: se divide en (PriorityQueue y LinkedList) Lo mismo que la anterior, pero en un orden de prioridad
     * Map: se divide en (SortedMap(TreeMap), HashMap, Hashtable y LinkedHashMap) Se asocia una clave con un valor para tener un mejor control de los datos sin un orden concreto
     *
     *
     * Los Hash se debe de utilizar un equals y HashCode, además de añadir un toString en el codigo
     * Si utilizas Comparable en el codigo, se debe de utilizar un compareTo cuando es una comparacion asi misma con otros objetos
     */
