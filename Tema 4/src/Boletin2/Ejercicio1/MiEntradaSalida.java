...
public class MiEntradaSalida {
    ...
    public static String solicitarCaracterSN(String mensaje) {
        char c = '0';
    ...
    public static int seleccionarOpcion(String mensaje, char[] sexo) {
        ...
        while (flag) {
            ...
            opcionElegida = Boletin1.Ejercicio2.MiEntradaSalida.solicitarEnteroEnRango(mensaje, 1, sexo.length);
            flag = false;
        }
