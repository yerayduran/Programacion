    ...
    public static int solicitarEntero(String mensaje) {
        ...
        while (flag) {
            ...
            // Si se lanza la excepción, informamos al usuario de su error.
                ...
                // 2. Boletin3.Boletin4.Ejercicio2.Ejercicio2.Mensaje de error específico.
        ...
        while (flag) {
            ...
            try {
                ...
                if (integer >= 0) {
                    ...
                    // 2. Boletin3.Boletin4.Ejercicio2.Ejercicio2.Mensaje de error específico (error de lógica, no de formato).
                    System.out.println("Error: El número debe ser positivo o cero.");
                }
            }
            // Si se lanza la excepción, informamos al usuario de su error.
            catch (NumberFormatException e) {
                // 2. Boletin3.Boletin4.Ejercicio2.Ejercicio2.Mensaje de error específico (error de formato).
                System.out.println("Error: Debe introducir un número entero.");
            }
        ...
        while (flag) {
            ...
            try {
                ...
                if (integer >= limiteInferior && integer <= limiteSuperior) {
                    ...
                    // 2. Boletin3.Boletin4.Ejercicio2.Ejercicio2.Mensaje de error específico (error de lógica).
        ...
        while (flag) {
            ...
            if (cadena.length() == 1) {
                ...
                if (c == 'S' || c == 'N') {
                    ...
                    // 2. Boletin3.Boletin4.Ejercicio2.Ejercicio2.Mensaje de error específico (carácter incorrecto).
                    System.out.println("Error: Respuesta no válida. Debe introducir 'S' o 'N'.");
                }
            } else {
                // 2. Boletin3.Boletin4.Ejercicio2.Ejercicio2.Mensaje de error específico (longitud incorrecta).
