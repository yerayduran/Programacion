...
public class Linea {
    ...
    // Constructor que recibe los puntos A y B de la clase 'Boletin2.Boletin4.Ejercicio5.Ejercicio5.Punto'
    public Linea(Punto puntoA, Punto puntoB) {
        this.puntoA = puntoA;
        this.puntoB = puntoB;
    }

    // Constructor que le da unos valores a los atributos de la clase 'Boletin2.Boletin4.Ejercicio5.Ejercicio5.Punto'
    public Linea() {
    ...
    public boolean equals(Object o) {
        ...
        // Se transforma el objeto de la clase 'Object' a la clase 'Boletin2.Boletin4.Ejercicio5.Ejercicio5.Linea'
        Linea linea = (Linea) o;
    ...
    public String toString() {
        return "Boletin2.Boletin4.Ejercicio5.Ejercicio5.Linea {" + "puntoA =" + puntoA + ", puntoB = " + puntoB + " }";
    }
}